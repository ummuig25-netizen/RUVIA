  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground">
      <header className="flex items-center justify-between px-6 py-5">
        <button
          onClick={() => navigate(currentUser.role === "driver" ? "/driver" : "/passenger")}
      ...
      <main className="max-w-md mx-auto px-6 py-8">
        ...
        <div className="mt-8 rounded-2xl bg-card border border-card-border divide-y divide-card-border">
        ...
        <button
          onClick={signOut}
          className="mt-6 w-full py-3.5 rounded-full border border-destructive/40 text-destructive hover:bg-destructive/10 transition-colors flex items-center justify-center gap-2 font-medium"
